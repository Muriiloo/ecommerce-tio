...
const WhatsappButton = () => {
  return (
    <Link
      ...
      className="fixed bottom-4 right-4 z-50 group flex items-center bg-green-600 text-white rounded-full shadow-lg overflow-hidden transition-all duration-600 ease-in-out"
    >
      {/* Ícone */}
      <div className="p-4">
        <svg
      ...
      <span className="max-w-0 opacity-0 group-hover:max-w-xs group-hover:opacity-100 transition-all duration-600 ease-in-out px-0 group-hover:px-3 whitespace-nowrap overflow-hidden text-base font-medium">
        Fale conosco!
      </span>
    </Link>
  );
