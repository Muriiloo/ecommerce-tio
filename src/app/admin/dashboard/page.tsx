    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
          ...
          <h3 className="text-gray-600 font-medium mb-2">Vendas da Semana</h3>
          <p className="text-3xl font-bold text-gray-900 mb-1">
            R$ {totalWeek}
          </p>
        </div>
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
          ...
          <p className="text-3xl font-bold text-gray-900 mb-1">R$ {totalDay}</p>
        </div>{" "}
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
        <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Evolução das vendas ao longo do ano</p>
          </div>
        ...
        <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Performance das últimas semanas</p>
          </div>
          <div className="rounded-2xl overflow-hidden">
